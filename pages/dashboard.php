    ...
    <header>
        ...
        <div class="NavBoard">
            ...
            <nav>
                <ul>
                    <li><a href="">
                        <img width="50" height="50" src="https://img.icons8.com/ios/100/combo-chart--v1.png" alt="combo-chart--v1"/>
                    </a></li>

                    <li><a href="">
                        <img width="50" height="50" src="https://img.icons8.com/ios/100/partly-cloudy-day--v1.png" alt="partly-cloudy-day--v1"/>
                    </a></li>

                    <li><a href="">
                        <img width="50" height="50" src="https://img.icons8.com/ios/100/robot-3.png" alt="robot-3"/>
                    </a></li>
